...
create table if not exists consulta (id int not null auto_increment, medico_responsavel int not null, convenio_id int, paciente_id int not null, foreign key (medico_responsavel) references medico (id), foreign key (convenio_id) references convenio (id), foreign key (paciente_id) references paciente (id), valor int not null, data_hora_consulta datetime not null, primary key (id)); 

create table if not exists receita (id int not null auto_increment, paciente_id int not null, medico_responsavel int not null, instruções_uso varchar(255) not null, nome_medicamento varchar(255) not null, quantidade int not null, consulta_id int not null, foreign key (paciente_id) references paciente (id), foreign key (medico_responsavel) references medico (id), foreign key (consulta_id) references consulta (id) ,primary key (id));
...
insert into medico (nome_medico, tipo_medico, especialidade)
values ('gabriel augusto', 'especialista', 1);
insert into medico (nome_medico, tipo_medico, especialidade)
values ('gabriel pacheco', 'residencia', 4);
...
insert into paciente (convenio_id, nome, telefone, rg, cpf, email, endereço, data_nascimento)
values (01, 'marcos leonardo', 11951683123, 165980187, 35480014878, 'marcosleo@gmail.com', 'rua do pão, 51', '2005-05-27');
insert into paciente (convenio_id, nome, telefone, rg, cpf, email, endereço, data_nascimento)
values (02, 'lierson silva', 11941651484, 438133018, 54548901499, 'liersonsilva@gmail.com', 'avenida tres rios, 4118', '2003-05-27');
insert into paciente (convenio_id, nome, telefone, rg, cpf, email, endereço, data_nascimento)
...
insert into paciente (nome, telefone, rg, cpf, email, endereço, data_nascimento)
values ('gilmar costa', 11954523374, 487103659, 35897410455, 'gilmarcosta1@gmail.com', 'rua do lineu, 56', '2002-04-01');
insert into paciente (nome, telefone, rg, cpf, email, endereço, data_nascimento)
values ('leonardo pacheco', 11907238871, 584274525, 48752122477, 'checoleo@gmail.com', 'rua do sinistreu, 489', '2001-01-18');

insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
values (4, 3, 12, 654, '2018-09-12 23:21:22');
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
values (2, 2, 6, 1200, '2021-08-30 19:24:11');
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
values (6, 1, 2, 300, '2016-11-18 11:05:47');
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
...
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
values (2, 2, 3, 1300, '2020-05-08 14:00:38');
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
values (7, 1, 2, 3000, '2020-12-16 19:47:12');
insert into consulta (medico_responsavel, convenio_id, paciente_id, valor, data_hora_consulta)
...
insert into consulta (medico_responsavel, paciente_id, valor, data_hora_consulta)
values (2, 16, 5675, '2021-03-16 15:01:55');
insert into consulta (medico_responsavel, paciente_id, valor, data_hora_consulta)
values (2, 17, 7800, '2021-05-19 17:28:03');

insert into receita (consulta_id, paciente_id, medico_responsavel, instruções_uso, nome_medicamento, quantidade)
values (1, 12, 4, 'Tomar 2 comprimidos por dia', 'diazepam', 2);
insert into receita (consulta_id, paciente_id, medico_responsavel, instruções_uso, nome_medicamento, quantidade)
values (2, 6, 2, 'Tomar 1 comprimido por dia', 'ibuprofeno', 1);
insert into receita (consulta_id, paciente_id, medico_responsavel, instruções_uso, nome_medicamento, quantidade)
values (3, 2, 6, 'Tomar 1 comprimidos por dia', 'isotretinoina', 1);
...
insert into internação (medico_responsavel, paciente_id, quarto_id, enfermeiro_responsavel_id, procedimento, data_entrada, data_prev_alta, data_alta)
values (9, 15, 1, 7, 'internação', '2018-05-06 20:31:22', '2018-05-19 15:00:00', '2018-05-19 15:00:00');
insert into internação (medico_responsavel, paciente_id, quarto_id, enfermeiro_responsavel_id, procedimento, data_entrada, data_prev_alta, data_alta)
...
insert into internação (medico_responsavel, paciente_id, quarto_id, enfermeiro_responsavel_id, procedimento, data_entrada, data_prev_alta, data_alta)
values (2, 4, 3, 5, 'internação', '2021-07-14 16:50:48', '2021-08-02 13:00:00', '2021-07-30 08:22:15');
...
select * from consulta inner join convenio on consulta.convenio_id = convenio.id inner join (select avg(valor) as `média do periodo` from consulta where data_hora_consulta between '2020-01-01' and '2020-12-31') as average where data_hora_consulta between '2020-01-01' and '2020-12-31' and convenio_id > 0;

select * from internação where data_alta > data_prev_alta;

select max(valor), consulta.id, consulta.medico_responsavel, consulta.paciente_id, consulta.convenio_id, consulta.data_hora_consulta from consulta where consulta.convenio_id is null;
select min(valor), consulta.id, consulta.medico_responsavel, consulta.paciente_id, consulta.convenio_id, consulta.data_hora_consulta from consulta where consulta.convenio_id is null;

select * from internação inner join quarto on internação.quarto_id = quarto.numero;

select nome, data_hora_consulta, nome_medico, especialidade from ((consulta inner join medico on consulta.medico_responsavel=medico.id) inner join paciente on paciente.id=consulta.paciente_id) where data_nascimento >= '2004-01-01'  and especialidade != 1;

select * from consulta;
select * from medico where nome_medico like '%gabriel%';
select enfermeiro.id, enfermeiro.nome, enfermeiro.cpf, enfermeiro.cre, count(enfermeiro.id) from enfermeiro inner join internação on enfermeiro.id = internação.enfermeiro_responsavel_id group by enfermeiro.id having count(enfermeiro.id) >= 2;
